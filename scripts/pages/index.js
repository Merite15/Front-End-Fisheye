...
/**
 * Récupère les valeurs des photographes via Json et les afficher
 * @param photographers
...
async function displayData(photographers) {
    ...
    photographers.forEach((photographer) => {
        ...
        const photographerInfo = photographerModel.getInfo();
        photographersSection.appendChild(photographerInfo);
    });
